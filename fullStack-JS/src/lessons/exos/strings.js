...
let prenom = "Ash";
let pizza = {
    nom: "pizza bolognaise",
    supplements: "ananas, kebab, fromage"
};
...
Bonjour/Bonsoir ${prenom} ${nom} votre ${pizza.nom} avec suppléments ${pizza.supplements} (${prix}₽) est bien prête, elle vous sera livrée dans 30 minutes à l'adresse suivante : ${adresse}.
${merci}
${blague}`;
